...
<form action="add_student" method="post">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="formGroupExampleInput3" name="gender" placeholder="请输入性别男或女" required>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        <label for="formGroupExampleInput7" class="form_label">班级编号</label>
    ...
    <div class="mb-3">
        ...
        <div data-role="controlgroup" data-ajax="false">
            ...
            <select id="select_area" name="village"></select>
        </div>
    </div>
